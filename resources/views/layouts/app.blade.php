...
<head>
  ...
  <script src="httpsmaxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js"></script>


    <link rel="stylesheet" href="/style/main.css">
    

    <!-- JavaScripts -->{{-- <script src="{{ elixir('js/app.js') }}"></script> --}}
